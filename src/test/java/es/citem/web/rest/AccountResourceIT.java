package es.citem.web.rest;

import static es.citem.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import es.citem.CitemApp;
import es.citem.config.Constants;
import es.citem.domain.Authority;
import es.citem.domain.User;
import es.citem.repository.AuthorityRepository;
import es.citem.repository.UserRepository;
import es.citem.security.AuthoritiesConstants;
import es.citem.service.UserService;
import es.citem.service.dto.PasswordChangeDTO;
import es.citem.service.dto.UserDTO;
import es.citem.web.rest.vm.KeyAndPasswordVM;
import es.citem.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = CitemApp.class)
